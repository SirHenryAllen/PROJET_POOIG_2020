...
public class Niveau extends Groupe {
	...
	public final void levelThree() {
		//blocks fixes
		for(int i = 11 ; i<21 ; i++ ){
			this._plateau.setBlock(i, 10, new BlockFixe('a'));
		}
		for(int i = 1 ; i<11 ; i++ ){
			this._plateau.setBlock(11, i, new BlockFixe('a'));
		}
		this._plateau.setBlock(12, 1, new BlockFixe('a'));
		this._plateau.setBlock(12, 2, new BlockFixe('a'));
		this._plateau.setBlock(13, 1, new BlockFixe('a'));
		this._plateau.setBlock(13, 2, new BlockFixe('a'));
		this._plateau.setBlock(14, 1, new BlockFixe('a'));
		this._plateau.setBlock(14, 8, new BlockFixe('a'));
		this._plateau.setBlock(14, 9, new BlockFixe('a'));
		this._plateau.setBlock(13, 7, new BlockFixe('a'));
		this._plateau.setBlock(13, 8, new BlockFixe('a'));
		this._plateau.setBlock(13, 9, new BlockFixe('a'));
		this._plateau.setBlock(12, 7, new BlockFixe('a'));
		this._plateau.setBlock(12, 8, new BlockFixe('a'));
		this._plateau.setBlock(12, 9, new BlockFixe('a'));
		//Animaux
		this._plateau.setBlock(12, 3, new Animaux('a'));
		this._plateau.setBlock(12, 4, new Animaux('a'));
		this._plateau.setBlock(12, 5, new Animaux('a'));
		this._plateau.setBlock(12, 6, new Animaux('a'));
		//Blocks destructibles
		for(int i = 15 ; i<21 ; i++ ){
			this._plateau.setBlock(i, 9, new BlockDestructible('b'));
		}
		for(int i = 15 ; i<21 ; i++ ){
			this._plateau.setBlock(i, 8, new BlockDestructible('a'));
		}
		...
		this._plateau.setBlock(15, 2, new BlockDestructible('b'));
		this._plateau.setBlock(15, 3, new BlockDestructible('d'));
		this._plateau.setBlock(15, 4, new BlockDestructible('c'));
		this._plateau.setBlock(15, 5, new BlockDestructible('d'));
		this._plateau.setBlock(15, 6, new BlockDestructible('d'));
		this._plateau.setBlock(15, 7, new BlockDestructible('b'));

		this._plateau.setBlock(16, 1, new BlockDestructible('d'));
		this._plateau.setBlock(16, 2, new BlockDestructible('d'));
		this._plateau.setBlock(16, 3, new BlockDestructible('b'));
		this._plateau.setBlock(16, 4, new BlockDestructible('a'));
		this._plateau.setBlock(16, 5, new BlockDestructible('b'));
		this._plateau.setBlock(16, 6, new BlockDestructible('b'));
		this._plateau.setBlock(16, 7, new BlockDestructible('d'));

		this._plateau.setBlock(17, 1, new BlockDestructible('d'));
		this._plateau.setBlock(17, 2, new BlockDestructible('b'));
		this._plateau.setBlock(17, 3, new BlockDestructible('b'));
		this._plateau.setBlock(17, 4, new BlockDestructible('c'));
		this._plateau.setBlock(17, 5, new BlockDestructible('d'));
		this._plateau.setBlock(17, 6, new BlockDestructible('d'));
		this._plateau.setBlock(17, 7, new BlockDestructible('d'));

		this._plateau.setBlock(18, 1, new BlockDestructible('d'));
		this._plateau.setBlock(18, 2, new BlockDestructible('b'));
		this._plateau.setBlock(18, 3, new BlockDestructible('d'));
		this._plateau.setBlock(18, 4, new BlockDestructible('a'));
		this._plateau.setBlock(18, 5, new BlockDestructible('b'));
		...
		this._plateau.setBlock(19, 2, new BlockSpecial('a'));
		this._plateau.setBlock(19, 3, new BlockDestructible('b'));
		this._plateau.setBlock(19, 4, new BlockDestructible('c'));
		this._plateau.setBlock(19, 5, new BlockDestructible('b'));
		this._plateau.setBlock(19, 6, new BlockDestructible('d'));
		this._plateau.setBlock(19, 7, new BlockDestructible('c'));

		this._plateau.setBlock(20, 1, new BlockDestructible('c'));
		this._plateau.setBlock(20, 2, new BlockDestructible('d'));
		this._plateau.setBlock(20, 3, new BlockDestructible('d'));
		this._plateau.setBlock(20, 4, new BlockSpecial('b'));
		this._plateau.setBlock(20, 5, new BlockDestructible('b'));
		this._plateau.setBlock(20, 6, new BlockDestructible('b'));
		this._plateau.setBlock(20, 7, new BlockDestructible('c'));
	}
